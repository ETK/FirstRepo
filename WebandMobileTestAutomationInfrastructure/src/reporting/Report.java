...
public class Report{
	...
	public static String commonName = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
	...
	public static void generateReport() {
     ...
     try {
         ...
         //   BufferedReader txtfile = new BufferedReader(new FileReader(System.getProperty("user.dir")+"\\TestReport\\2013-12-03_17-04-24.txt"));
            OutputStream htmlfile= new FileOutputStream(new File(System.getProperty("user.dir")+"\\Report\\"+main.main.type+" Test Automation Infrastructure "+commonName+".html"));
            ...
            printhtml.println("<TH BGCOLOR=\"#CC0000\" COLSPAN=\"2\"><BR><H3> "+main.main.type+" Test Automation Report</H3>");
            ...
            if(Log.resultMap.size() != 0){
            	 keys = Log.resultMap.keySet().toArray();
                 values = Log.resultMap.values().toArray();
            }
